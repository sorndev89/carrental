...
<!-- <div id="global-loader">
	...
	<!-- Main Wrapper -->
	<div class="main-wrapper" :class="ShowMenuMobile?'slide-nav':''">
		...
		<div class="header">
			<div class="main-header ">
				...
				<!-- /Logo --> 
				<a id="mobile_btn" class="mobile_btn" @click="ShowMenuMobile=!ShowMenuMobile"
				...
				<ul class="nav user-menu">
							...
							<form action="#" class="dropdown">
								<div class="searchinputs input-group dropdown-toggle" id="dropdownMenuClickable" data-bs-toggle="dropdown" data-bs-auto-close="outside">
									...
									<span class="input-group-text">
										<kbd class="d-flex align-items-center"><img :src="url + '/assets/img/icons/command.svg'" alt="img" class="me-1">K</kbd>
									</span>
								</div>
								<div class="dropdown-menu search-dropdown" aria-labelledby="dropdownMenuClickable">
									...
									<div class="search-info">
										...
										<ul class="customers">
											<li><a href="javascript:void(0);">Aron Varu<img :src="url + '/assets/img/profiles/avator1.jpg'" alt="Img" class="img-fluid"></a></li>
											<li><a href="javascript:void(0);">Jonita<img :src="url + '/assets/img/profiles/avatar-01.jpg'" alt="Img" class="img-fluid"></a></li>
											<li><a href="javascript:void(0);">Aaron<img :src="url + '/assets/img/profiles/avatar-10.jpg'" alt="Img" class="img-fluid"></a></li>
										</ul>
									</div>
								</div>
							</form>
					...
					<li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
						<a href="javascript:void(0);" class="dropdown-toggle nav-link select-store"
							...
							<span class="user-info">
								<span class="user-letter">
									<img :src="url + 'assets/img/store/store-01.png'" alt="Store Logo" class="img-fluid">
								</span>
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a href="javascript:void(0);" class="dropdown-item">
								<img :src="url + '/assets/img/store/store-01.png'" alt="Store Logo" class="img-fluid">Freshmart
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
								<img :src="url + '/assets/img/store/store-02.png'" alt="Store Logo" class="img-fluid">Grocery Apex
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
								<img :src="url + '/assets/img/store/store-03.png'" alt="Store Logo" class="img-fluid">Grocery Bevy
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
								<img :src="url + '/assets/img/store/store-04.png'" alt="Store Logo" class="img-fluid">Grocery Eden
							</a>
						</div>
					</li>
					<!-- /Select Store -->
					...
					<li class="nav-item dropdown has-arrow flag-nav nav-item-box">
						<a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);"
							role="button">
							<img :src="url + '/assets/img/flags/us-flag.svg'" alt="Language" class="img-fluid">
						</a>
						<div class="dropdown-menu dropdown-menu-right">
							<a href="javascript:void(0);" class="dropdown-item">
								<img :src="url +'/assets/img/flags/english.svg'" alt="Img" height="16">English
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
								<img :src="url + '/assets/img/flags/arabic.svg'" alt="Img" height="16">Arabic
							</a>
						</div>
					</li>
					<!-- /Flag -->
								...
								<ul class="notification-list">
										...
										<a href="activities.html">
											<div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" :src="url + '/assets/img/profiles/avatar-13.jpg'">
												</span>
									...
									<li class="notification-message">
										<a href="activities.html">
											<div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" :src="url + '/assets/img/profiles/avatar-03.jpg'">
												</span>
												<div class="flex-grow-1">
									...
									<li class="notification-message">
										<a href="activities.html" class="recent-msg">
											<div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" :src="url + '/assets/img/profiles/avatar-17.jpg'">
												</span>
												<div class="flex-grow-1">
									...
									<li class="notification-message">
										<a href="activities.html" class="recent-msg">
											<div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" :src="url + '/assets/img/profiles/avatar-02.jpg'">
												</span>
												<div class="flex-grow-1">
	...
	<div class="sidebar-overlay " :class="ShowMenuMobile?'opened':''" @click="ShowMenuMobile=!ShowMenuMobile"></div>
</template>
<script>
...
export default {
    ...
    mounted() {
        console.log('App.vue mounted. Current path:', this.$route.path);
    }
}
</script>
<style lang="">
